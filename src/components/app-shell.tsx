    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative mx-auto flex max-w-[1500px] gap-4 p-4">
        ...
        <main className="min-w-0 flex-1 space-y-4">
          {/* Perbaikan di baris bawah ini: ditambah relative z-40 agar menu melayang di depan kartu */}
              ...
              <div className="relative">
                ...
                {profileMenuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full z-50 mt-2 w-52 rounded-2xl border border-white/1
